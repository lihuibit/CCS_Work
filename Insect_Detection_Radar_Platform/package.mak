...
override PKGDIR = Insect_Detection_Radar_Platform
...
package/%.xdc.inc package/%_Insect_Detection_Radar_Platform.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package Insect_Detection_Radar_Platform" (because $@ is older than $(firstword $?))" ...
...
package/rel/undefinedInsect_Detection_Radar_Platformpackage/package.rel.xml: package/package.cfg.xdc.inc
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	@$(MSG) generating schema include file list ...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js Insect_Detection_Radar_Platform $@
...
.PHONY: release,Insect_Detection_Radar_Platform
Insect_Detection_Radar_Platform.zip: package/package.bld.xml
Insect_Detection_Radar_Platform.zip: package/build.cfg
Insect_Detection_Radar_Platform.zip: package/package.xdc.inc
Insect_Detection_Radar_Platform.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/Insect_Detection_Radar_Platform.zip.dep
endif
package/rel/Insect_Detection_Radar_Platform/Insect_Detection_Radar_Platform/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

Insect_Detection_Radar_Platform.zip: package/rel/Insect_Detection_Radar_Platform.xdc.inc package/rel/Insect_Detection_Radar_Platform/Insect_Detection_Radar_Platform/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/Insect_Detection_Radar_Platform.xdc.inc,package/rel/Insect_Detection_Radar_Platform.zip.dep)


release release,Insect_Detection_Radar_Platform: all Insect_Detection_Radar_Platform.zip
clean:: .clean
	-$(RM) Insect_Detection_Radar_Platform.zip
	-$(RM) package/rel/Insect_Detection_Radar_Platform.xdc.inc
	-$(RM) package/rel/Insect_Detection_Radar_Platform.zip.dep
